...
class VisualEBranchformerEncoder(AbsEncoder):
    ...
    def forward(
        ...
        # print("before concat",xs_pad.shape, masks.shape)
        ...
        # print("after concat",xs_pad.shape, masks.shape) 
        # before concat torch.Size([4, 749, 384]) torch.Size([4, 1, 749])
        # after concat torch.Size([4, 753, 384]) torch.Size([4, 1, 753])
        intermediate_outs = []
        ...
        # print("xs_pad, olens",xs_pad.shape, olens) xs_pad, olens torch.Size([4, 749, 384]) tensor([749, 749, 749, 749], device='cuda:0')
